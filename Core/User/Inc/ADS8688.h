...
#define CHNS_NUM_READ                                                                                                  \
    8 // the number of channel you want to get the raw data (you also have to adjust the AUTO_SEQ_EN register value to
      // match with the number of channel you like to read)
